...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="pause", brief="Music Commands")
    async def pause_command(self, ctx, cmd: Optional[str]):
        """Pauses current song. Use the play command to resume song."""
        player = self.get_player(ctx)
    ...
    @commands.command(name="next", aliases=["skip"], brief="Music Commands")
    async def next_command(self, ctx, cmd: Optional[str]):
        """Skips song in queue."""
        player = self.get_player(ctx)
    ...
    @commands.command(name="previous", brief="Music Commands")
    async def previous_command(self, ctx, cmd: Optional[str]):
        """Plays previous song"""
        player = self.get_player(ctx)
    ...
    @commands.command(name="shuffle", brief="Music Commands")
    async def shuffle_command(self, ctx, cmd: Optional[str]):
        """Mixes the music order in the queue."""
        player = self.get_player(ctx)
    ...
    @commands.command(name="queue", brief="Music Commands")
    async def queue_command(self, ctx, show: t.Optional[int] = 10):
        """Displays up to 10 songs added to the playlist."""
        player = self.get_player(ctx)
    ...
    @commands.command(name="Volume", brief="Music Commands")
    async def volume_changer(self, ctx, vol: int = None ):
        player =self.get_player(ctx)
        if vol is None or not 1 < vol < 101:
            await ctx.send("Please use a number beteween `1-100`")
